...
Unlike gaussianimage_cholesky_hsi.py (which uses Gabor rasterizer),
this module uses rasterize_gaussians_sum from gsplat — the true
Gaussian splatting path.
...
class GaussianImage_Gaussian_HSI(nn.Module):
    ...
    Supports arbitrary rank.  No Gabor modulation, no quantization.
    """
