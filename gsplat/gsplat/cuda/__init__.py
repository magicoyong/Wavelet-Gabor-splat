...
rasterize_forward_sum_gabor_4ch = _make_lazy_cuda_func("rasterize_forward_sum_gabor_4ch")
rasterize_backward_sum_gabor_4ch = _make_lazy_cuda_func("rasterize_backward_sum_gabor_4ch")