...
__global__ void project_gaussians_2d_backward_kernel(
    ...
    // ========== 输出梯度 ==========
    float3* __restrict__ v_cov2d,  // ∂Loss/∂cov2d [num_points, 3]
    float2* __restrict__ v_mean2d, // ∂Loss/∂means2d [num_points, 2]
    float3* __restrict__ v_L_elements // ∂Loss/∂L_elements [num_points, 3]
) {
