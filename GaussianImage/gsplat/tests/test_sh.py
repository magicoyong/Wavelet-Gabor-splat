...
def test_sh():
    ...
    sh_coeffs = torch.rand(
        num_points, sh3d.num_sh_bases(degree), 3, device=device, requires_grad=True
    )
    ...
    for _ in range(num_iters):
        ...
        check_colors = _torch_impl3d.compute_sh_color(viewdirs, sh_coeffs)
        ...
        colors = sh3d.spherical_harmonics(degree, viewdirs, sh_coeffs)
